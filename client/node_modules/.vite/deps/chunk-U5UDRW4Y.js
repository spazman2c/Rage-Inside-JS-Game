...
var PassPostProcess = class _PassPostProcess extends PostProcess {
   ...
   */
  constructor(name43, options, camera = null, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    super(name43, "pass", null, null, options, camera, samplingMode, engine, reusable, void 0, textureType, void 0, null, blockCompilation);
  }
  /**
   * @internal
   */
...
var PassCubePostProcess = class _PassCubePostProcess extends PostProcess {
   ...
   */
  constructor(name43, options, camera = null, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    super(name43, "passCube", null, null, options, camera, samplingMode, engine, reusable, "#define POSITIVEX", textureType, void 0, null, blockCompilation);
    this._face = 0;
  }
  /**
   * @internal
...
var FileFaceOrientation = class {
  constructor(name43, worldAxisForNormal, worldAxisForFileX, worldAxisForFileY) {
    this.name = name43;
...
var name3 = "pbrFragmentDeclaration";
var shader3 = `uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
var name4 = "pbrUboDeclaration";
var shader4 = `layout(std140,column_major) uniform;uniform Material {vec2 vAlbedoInfos;vec4 vAmbientInfos;vec2 vOpacityInfos;vec2 vEmissiveInfos;vec2 vLightmapInfos;vec3 vReflectivityInfos;vec2 vMicroSurfaceSamplerInfos;vec2 vReflectionInfos;vec2 vReflectionFilteringInfo;vec3 vReflectionPosition;vec3 vReflectionSize;vec3 vBumpInfos;mat4 albedoMatrix;mat4 ambientMatrix;mat4 opacityMatrix;mat4 emissiveMatrix;mat4 lightmapMatrix;mat4 reflectivityMatrix;mat4 microSurfaceSamplerMatrix;mat4 bumpMatrix;vec2 vTangentSpaceParams;mat4 reflectionMatrix;vec3 vReflectionColor;vec4 vAlbedoColor;vec4 vLightingIntensity;vec3 vReflectionMicrosurfaceInfos;float pointSize;vec4 vReflectivityColor;vec3 vEmissiveColor;vec3 vAmbientColor;vec2 vDebugMode;vec4 vMetallicReflectanceFactors;vec2 vMetallicReflectanceInfos;mat4 metallicReflectanceMatrix;vec2 vReflectanceInfos;mat4 reflectanceMatrix;vec3 vSphericalL00;vec3 vSphericalL1_1;vec3 vSphericalL10;vec3 vSphericalL11;vec3 vSphericalL2_2;vec3 vSphericalL2_1;vec3 vSphericalL20;vec3 vSphericalL21;vec3 vSphericalL22;vec3 vSphericalX;vec3 vSphericalY;vec3 vSphericalZ;vec3 vSphericalXX_ZZ;vec3 vSphericalYY_ZZ;vec3 vSphericalZZ;vec3 vSphericalXY;vec3 vSphericalYZ;vec3 vSphericalZX;
...
var name5 = "pbrFragmentExtraDeclaration";
var shader5 = `varying vec3 vPositionW;
#if DEBUGMODE>0
...
var name6 = "samplerFragmentAlternateDeclaration";
...
var shader7 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
var shader10 = `#define MINIMUMVARIANCE 0.0005
...
var shader12 = `struct preLightingInfo
...
var shader14 = `#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
var name26 = "pbrBlockIridescence";
var shader26 = `struct iridescenceOutParams
...
var name27 = "pbrBlockSubSurface";
var shader27 = `struct subSurfaceOutParams
...
var name28 = "pbrBlockNormalGeometric";
var shader28 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
var name29 = "pbrBlockNormalFinal";
var shader29 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name30 = "pbrBlockLightmapInit";
var shader30 = `#ifdef LIGHTMAP
...
var name31 = "pbrBlockGeometryInfo";
var shader31 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var name32 = "pbrBlockReflectance0";
var shader32 = `float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
var name33 = "pbrBlockReflectance";
var shader33 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var name34 = "pbrBlockDirectLighting";
var shader34 = `vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
var name35 = "pbrBlockFinalLitComponents";
var shader35 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
var name36 = "pbrBlockFinalUnlitComponents";
var shader36 = `vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,0.0);finalDiffuse*=vLightingIntensity.x;vec3 finalAmbient=vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;vec3 finalEmissive=vEmissiveColor;
#ifdef EMISSIVE
...
var name37 = "pbrBlockFinalColorComposition";
var shader37 = `vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
var name38 = "pbrBlockImageProcessing";
var shader38 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var name40 = "pbrPixelShader";
var shader40 = `#if defined(BUMP) || !defined(NORMAL) || defined(FORCENORMALFORWARD) || defined(SPECULARAA) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
var name41 = "pbrVertexDeclaration";
var shader41 = `uniform mat4 view;uniform mat4 viewProjection;
#ifdef ALBEDO
...
var name42 = "pbrVertexShader";
var shader42 = `precision highp float;
...
var PBRMaterial = class _PBRMaterial extends PBRBaseMaterial {
   ...
   */
  clone(name43, cloneTexturesOnlyOnce = true, rootUrl = "") {
    const clone = SerializationHelper.Clone(() => new _PBRMaterial(name43, this.getScene()), this, { cloneTexturesOnlyOnce });
    clone.id = name43;
    clone.name = name43;
...
//# sourceMappingURL=chunk-U5UDRW4Y.js.map
